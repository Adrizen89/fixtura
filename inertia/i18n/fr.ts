...
export default {
  ...
  tournamentsAdmin: {
    index: {
      subtitle: 'Gérez vos tournois et leurs plannings.',
      newTournament: 'Nouveau tournoi',
      empty: 'Aucun tournoi pour le moment.',
      createFirst: 'Créer le premier tournoi',
      date: 'Date',
      pitches: 'Terrains',
      teams: 'Équipes',
      start: 'Début',
      ...
      edit: 'Modifier',
      delete: 'Supprimer',
      deleteConfirm: 'Supprimer le tournoi « {name} » ? Cette action est irréversible.',
    },
    create: {
    ...
    edit: {
      headTitle: 'Modifier — {name}',
      title: 'Modifier le tournoi',
      submit: 'Enregistrer les modifications',
    },
    planning: {
      replaceConfirm: 'Cela remplacera le planning actuel (et les scores déjà saisis). Continuer ?',
      headTitle: 'Aperçu du planning — {name}',
      title: 'Aperçu du planning',
      intro:
        "Vérifiez le planning proposé, puis validez pour l'enregistrer. Rien n'est enregistré tant que vous n'avez pas validé.",
      regenWarning:
        'Un planning existe déjà pour ce tournoi. Le valider remplacera le planning actuel ainsi que les scores éventuellement saisis.',
      matches: 'Matchs',
      rounds: 'Journées',
      slots: 'Créneaux',
      timeRange: 'Plage horaire',
      cancel: 'Annuler',
      confirm: 'Valider ce planning',
    },
    results: {
      poolStandings: 'Classements par poule',
      bracket: 'Tableau',
      standings: 'Classement',
      liveConnected: 'En direct',
      liveConnecting: 'Connexion…',
      liveOffline: 'Hors ligne',
      headTitle: 'Résultats — {name}',
      title: 'Saisie des résultats',
      intro: 'Saisissez les scores au fil des matchs — le classement se met à jour aussitôt.',
      standingsPdf: 'Classement (PDF)',
      publicScreen: 'Écran public',
      empty: "Aucun match : générez d'abord le planning.",
      generateSchedule: 'Générer le planning',
      scores: 'Scores',
      liveTitleConnected: 'Mises à jour poussées en direct',
      liveTitleOffline:
        'Temps réel indisponible — la page reste fonctionnelle, rechargez pour la dernière version',
      bracketBelow: 'Le tableau final est affiché ci-dessous',
      standingsPending: "Le classement s'affichera dès le premier score saisi.",
      finalBracket: 'Tableau final',
    },
    show: {
      edit: 'Modifier',
      ...
      breakDuration: 'Pause entre matchs',
      lunchBreak: 'Pause déjeuner',
      qrAlt: "QR code vers l'écran public du tournoi",
      publicScreen: 'Écran public',
      publicScreenHint:
        'Partagez ce QR code aux équipes ou affichez-le au bord des terrains : il ouvre le classement et le planning en direct, en lecture seule.',
      openPublicScreen: "Ouvrir l'écran public",
      tvMode: 'Mode TV',
      qrSvg: 'QR code (SVG)',
      schedule: 'Planning',
      planningSummary: '{matches} matchs · {rounds} journées · {start}–{end}',
      enterResults: 'Saisir les résultats',
      regenerateSchedule: 'Régénérer le planning',
      generateSchedule: 'Générer le planning',
      print: 'Imprimer',
      schedulePdf: 'Planning (PDF)',
      matchSheetsPdf: 'Feuilles de match (PDF)',
      needTeams: 'Ajoutez au moins 2 équipes pour générer le planning.',
      noSchedule: "Aucun planning généré pour l'instant.",
    },
  },
  eventsAdmin: {
    index: {
      subtitle:
        'Un événement fait tourner plusieurs catégories le même jour sur un pool de terrains partagé.',
      newEvent: 'Nouvel événement',
      empty: 'Aucun événement pour le moment.',
      createFirst: 'Créer le premier événement',
      date: 'Date',
      pitches: 'Terrains',
      ...
      delete: 'Supprimer',
      confirmDelete:
        "Supprimer l'événement « {name} » ? Ses catégories resteront accessibles comme tournois.",
    },
    create: {
    ...
    planning: {
      headTitle: 'Aperçu du planning — {name}',
      title: 'Aperçu du planning combiné',
      subtitle:
        "Toutes les catégories sont placées sur le pool de terrains partagé, sans collision de créneau. Rien n'est enregistré tant que vous n'avez pas validé.",
      regenWarning:
        'Un planning existe déjà pour cet événement. Le valider remplacera le planning actuel ainsi que les scores éventuellement saisis.',
      matches: 'Matchs',
      categories: 'Catégories',
      slots: 'Créneaux',
      timeRange: 'Plage horaire',
      cancel: 'Annuler',
      validate: 'Valider ce planning',
      confirmValidate:
        'Cela remplacera le planning actuel (et les scores déjà saisis). Continuer ?',
    },
    show: {
      publicScreen: 'Écran public',
      edit: 'Modifier',
      formatChampionship: 'Championnat',
      formatPools: 'Poules',
      formatKnockout: 'Élimination directe',
      formatHybrid: 'Hybride',
      sharedSettings: 'Paramètres partagés',
      startTime: 'Heure de début',
      pitchesPool: 'Terrains (pool)',
      matchDuration: "Durée d'un match",
      breakBetween: 'Pause entre matchs',
      lunchBreak: 'Pause déjeuner',
      addCategory: 'Ajouter une catégorie',
      nameLabel: 'Nom',
      namePlaceholder: 'Tournoi U11',
      categoryLabel: 'Catégorie',
      formatLabel: 'Format',
      thirdPlace: 'Disputer la petite finale (3e place)',
      numPoolsLabel: 'Nombre de poules',
      adding: 'Ajout…',
      addCategorySubmit: 'Ajouter la catégorie',
      categoriesHeading: 'Catégories',
      categoriesEmpty: 'Ajoutez au moins une catégorie pour composer cet événement.',
      teams: '{count} équipe(s)',
      addAtLeast2: '— ajoutez au moins 2 équipes',
      manageTeams: 'Gérer les équipes',
      delete: 'Supprimer',
      confirmDeleteCategory: 'Supprimer la catégorie « {name} » et ses équipes / matchs ?',
      combinedSchedule: 'Planning combiné',
      planningSummary: '{matches} matchs · {slots} créneaux · {terrains} terrains · {start}–{end}',
      regenerate: 'Régénérer le planning',
      generate: 'Générer le planning',
      needTwoTeams:
        'Chaque catégorie doit compter au moins 2 équipes pour générer le planning combiné.',
      noPlanning: "Aucun planning généré pour l'instant.",
    },
  },
  membersAdmin: {
    ...
    inviteHeading: 'Inviter un organisateur',
    emailLabel: 'Adresse e-mail',
    emailPlaceholder: 'organisateur@exemple.fr',
    roleLabel: 'Rôle',
    roleOrganizer: 'Organisateur',
    roleOwner: 'Responsable',
    inviteButton: 'Inviter',
    pendingHeading: 'Invitations en attente',
    invitationMeta: '{role} · expire le {date}',
    revoke: 'Révoquer',
    ...
    you: '(vous)',
    roleForLabel: 'Rôle de {email}',
    remove: 'Retirer',
    confirmRemove: 'Retirer {email} du club ? Son accès sera supprimé.',
    confirmRevoke: "Révoquer l'invitation de {email} ?",
  },
  auditAdmin: {
    title: "Journal d'audit",
    subtitle:
      'Historique des actions sensibles du club (connexions, changements de rôle, suppressions). {count} entrée(s).',
    colDate: 'Date',
    colAction: 'Action',
    colAuthor: 'Auteur',
    colTarget: 'Cible',
    colIp: 'IP',
    empty: "Aucune action sensible enregistrée pour l'instant.",
    paginationLabel: 'Pagination du journal',
    previous: '← Précédent',
    ...
    action: {
      login: 'Connexion',
      memberInvited: "Invitation d'un membre",
      roleChanged: 'Changement de rôle',
      memberRemoved: "Retrait d'un membre",
      invitationRevoked: "Révocation d'invitation",
      tournamentDeleted: "Suppression d'un tournoi",
      eventDeleted: "Suppression d'un événement",
      categoryDeleted: "Suppression d'une catégorie",
      dataExported: 'Export des données du club',
    },
  },
  historyAdmin: {
    subtitle:
      'Consultez vos éditions terminées en lecture seule : planning, résultats et classement final figés.',
    emptyTitle: 'Aucune édition terminée pour le moment.',
    emptyHint: 'Un tournoi ou un événement apparaît ici une fois son statut passé à « Terminé ».',
    eventsHeading: 'Événements',
    tournamentsHeading: 'Tournois',
    date: 'Date',
    categories: 'Catégories',
    teams: 'Équipes',
    terrains: 'Terrains',
  ...
  palmaresAdmin: {
    ...
    emptyTitle: 'Aucune édition terminée pour le moment.',
    emptyHint: "Le palmarès se construit dès qu'un tournoi ou un événement est terminé.",
    teamRecordsHeading: 'Bilan par équipe',
    teamRecordsCaption:
      'Bilan cumulé par équipe : rang, nom, participations, victoires, finales et ratio de victoires.',
    colTeam: 'Équipe',
    colAppearancesTitle: 'Participations',
    colAppearancesShort: 'Part.',
    colAppearancesSr: ' — participations',
    colFinals: 'Finales',
    colTitles: 'Titres',
    colWinRate: 'Ratio',
    editionsHeading: 'Vainqueurs par édition',
    winnerUnknown: 'Vainqueur non déterminé',
    finalistLabel: 'Finaliste : {name}',
    format: {
  ...
  clubAdmin: {
    appearanceTitle: 'Apparence du club',
    backToTournaments: 'Tournois',
    appearanceIntro:
      "Personnalisez le logo et la couleur affichés sur l'écran public de vos tournois.",
    logoHeading: 'Logo',
    logoHint:
      'PNG, JPG, WEBP ou SVG · {max} Ko maximum. Stocké dans Fixtura, jamais partagé avec un tiers.',
    logoPreviewAlt: 'Aperçu du logo du club',
    none: 'Aucun',
    chooseFile: 'Choisir un fichier',
    removeLogo: 'Retirer le logo',
    errorFormat: 'Format non supporté (PNG, JPG, WEBP ou SVG).',
    errorTooLarge: 'Logo trop lourd (max {max} Ko).',
    errorRead: 'Lecture du fichier impossible.',
    colorHeading: "Couleur d'accent",
    colorHint: "Utilisée pour les éléments mis en avant sur l'écran public.",
    useCustomColor: 'Utiliser une couleur personnalisée',
    colorPickerLabel: 'Sélecteur de couleur',
    hexCodeLabel: 'Code couleur hexadécimal',
    save: 'Enregistrer',
  ...
  errors: {
    ...
    serverErrorHeading: 'Une erreur est survenue',
    serverErrorBody:
      "Un problème inattendu est survenu de notre côté. Réessayez dans un instant — si cela persiste, contactez l'organisateur.",
  },
  tournamentForm: {
    sections: {
      general: 'Général',
    ...
    format: {
      title: 'Format',
      hint: 'Détermine comment le planning est généré.',
      label: 'Type de compétition',
      options: {
        championship: 'Championnat — toutes les équipes se rencontrent',
        pools: 'Poules',
        knockout: 'Élimination directe',
        doubleElimination: 'Double élimination — repêchage + grande finale',
        hybrid: 'Hybride — poules puis phase finale',
        swiss: 'Système suisse — appariements par niveau, sans rematch',
      },
    },
    swissRounds: {
      label: 'Nombre de rondes',
      placeholder: 'Auto',
      hint: "Laisser vide pour automatique (⌈log₂ du nombre d'équipes⌉).",
    },
    numPools: {
    ...
    bestRunnersUp: {
      label: 'Meilleurs repêchés',
      hint: 'Repêche les meilleurs {rank} de poule, toutes poules confondues (0 = aucun repêchage).',
    },
    thirdPlace: {
      label: 'Disputer la petite finale (3e place)',
    },
    scoring: {
      title: 'Barème de points',
      hint: 'Points attribués au classement. Par défaut : victoire 3, nul 1, défaite 0.',
      win: 'Victoire',
      draw: 'Nul',
      loss: 'Défaite',
    },
    schedule: {
      title: 'Horaires & terrains',
      hint: 'Ces paramètres pilotent la génération automatique du planning.',
      startTime: 'Heure de début',
      numTerrains: 'Nombre de terrains',
      matchDuration: "Durée d'un match (min)",
      breakDuration: 'Pause entre matchs (min)',
      lunchStart: 'Début pause déjeuner',
      lunchDuration: 'Durée pause déjeuner (min)',
    },
    common: {
      optional: '(optionnel)',
    },
  ...
  eventForm: {
    ...
    schedule: {
      title: 'Horaires & terrains partagés',
      hint: 'Ces paramètres sont communs à toutes les catégories : le planning combiné est généré sur ce pool de terrains, sans collision de créneau entre catégories.',
      startTime: 'Heure de début',
      numTerrains: 'Nombre de terrains (pool partagé)',
      matchDuration: "Durée d'un match (min)",
      breakDuration: 'Pause entre matchs (min)',
      lunchStart: 'Début pause déjeuner',
      lunchDuration: 'Durée pause déjeuner (min)',
  ...
  teamsManager: {
    ...
    addLabel: "Nom de l'équipe à ajouter",
    namePlaceholder: "Nom de l'équipe",
    add: 'Ajouter',
    renameLabel: "Renommer l'équipe",
    save: 'Enregistrer',
    cancel: 'Annuler',
    contact: 'Contact : {email}',
    rename: 'Renommer',
    delete: 'Supprimer',
    empty: "Aucune équipe pour l'instant. Ajoutez la première ci-dessus.",
    confirmDelete: "Supprimer l'équipe « {name} » ?",
  },
  teamsImport: {
    title: 'Importer des équipes',
    subtitle: 'Depuis un fichier CSV ou Excel (une équipe par ligne).',
    close: 'Fermer',
    import: 'Importer',
    fileLabel: 'Fichier',
    fileHint: 'En-tête facultative (« Nom », « Équipe »…). Colonnes supplémentaires ignorées.',
    analyzing: 'Analyse du fichier…',
    errorFile: 'Import impossible. Vérifiez le fichier (CSV ou XLSX, ≤ 5 Mo).',
    errorNetwork: 'Import impossible (erreur réseau).',
    toImport: '{count} à importer',
    skipped: '{count} ignorée(s)',
    truncated: 'Fichier volumineux : seules les 500 premières lignes ont été analysées.',
    colLine: 'Ligne',
    colName: 'Nom',
    colStatus: 'État',
    emptyCell: '(vide)',
    noneDetected: 'Aucune équipe détectée dans ce fichier.',
    importCount: 'Importer {count} équipe(s)',
    cancel: 'Annuler',
    status: {
      ok: 'À importer',
      empty: 'Vide',
      tooLong: 'Trop long (> 60)',
      duplicateFile: 'Doublon (fichier)',
      duplicateExisting: 'Déjà présente',
    },
  },
  registrationManager: {
    ...
    closed: 'Fermées',
    intro:
      'Partagez un lien public pour que les équipes demandent leur inscription (sans compte). Vous validez ou refusez chaque demande ci-dessous.',
    occupancy: '{occupancy} / {capacity} place(s) occupée(s).',
    confirmed: '{count} équipe(s) confirmée(s).',
    capacityLabel: 'Capacité maximale',
    capacityHint: '(laisser vide = illimité)',
    unlimited: 'Illimité',
    openRegistration: 'Ouvrir les inscriptions',
    saveCapacity: 'Enregistrer la capacité',
    closeRegistration: 'Fermer les inscriptions',
    linkLabel: "Lien d'inscription",
    copied: 'Copié ✓',
    copy: 'Copier',
    openLink: 'Ouvrir',
    closedHint:
    ...
    approve: 'Valider',
    reject: 'Refuser',
    processed: '{count} demande(s) traitée(s)',
    approved: 'Validée',
    rejected: 'Refusée',
  },
  matchScoreRow: {
    byeWin: 'Exempt · victoire',
    homeScoreLabel: 'Score domicile',
    awayScoreLabel: 'Score extérieur',
    save: 'Enregistrer',
    incidentsTitle: 'Aléas : décaler, forfait',
    incidents: 'Aléas',
    drawShootout: 'Nul — vainqueur t.a.b.',
    shootoutWinnerLabel: 'Vainqueur aux tirs au but',
    thenSave: 'puis « Enregistrer »',
    forfeitWithTeam: 'Forfait — {team}',
    forfeit: 'Forfait',
    shootoutResult: 't.a.b. — {team}',
    enteredBy: 'Saisi par {name}',
    reschedule: 'Décaler',
    newTimeLabel: 'Nouvelle heure de {home} contre {away}',
    pitch: 'Terrain',
    forfeitHint: 'déclare forfait (défaite 3–0)',
  },
  planningGrid: {
    caption: 'Planning des matchs par créneau horaire, terrain et affiche.',
    time: 'Heure',
    pitch: 'Terrain',
    match: 'Match',
    score: 'Score',
